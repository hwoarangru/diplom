...
if($_POST["testdrive"]=="Y")
{
	$APPLICATION->SetTitle("Тест-драйв ".$_POST["model"]);
}
else
{
	$APPLICATION->SetTitle("Запросить индивидуальное предложение ".$_POST["model"]);
}?>
...
<div style="width: 200px; margin-left: 490px;">
